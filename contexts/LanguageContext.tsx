...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'hero.description': 'Get personalized AI workout plans, smart nutrition tracking, and a 24/7 online AI personal trainer that adapts to your fitness goals and daily routine',
    'hero.cta': 'Try AI Personal Trainer Free',
    'hero.aiCoach': 'Your AI Coach',
    'hero.onlineNow': 'Online now',
    'hero.todaysProgress': 'Today\'s Progress',
    ...
    'actions.trackProgress': 'Track Progress',
    ...
    'ai.progressResponse': 'I can see you\'re making excellent progress! Let\'s adjust your routine to keep challenging you. What\'s your energy level today?',
    ...
    'ai.trackResponse': 'Let me pull up your progress data! You\'ve been doing amazing - 85% workout completion rate this week and you\'re ahead of your calorie burn goals!',
    'ai.defaultResponse': 'I\'m here to help! What specific aspect of your fitness journey would you like to focus on?',
    
    // Workout Page
    'workout.title': 'Workout Schedule',
    'workout.loading': 'Loading workout schedule...',
    'workout.analyzing': 'Analyzing your conversations...',
    'workout.noSchedule': 'No workout schedule found. Chat with your AI coach to create one!',
    'workout.noScheduleDesc': 'No workout schedule found. Start a conversation with your AI coach to create a personalized workout plan!',
    'workout.programInfo': '{{days}} day program • Extracted from your conversations',
    'workout.exercisesCount': '{{count}} exercises • {{sets}} total sets',
    'workout.currentExercise': 'Currently focusing on this exercise',
    'workout.noExercises': 'No exercises found for this day.',
    'workout.weightUnit': 'Weight Unit',
    'workout.kilograms': 'Kilograms (kg)',
    'workout.pounds': 'Pounds (lb)',
    'workout.weight': 'Weight',
    'workout.reps': 'Reps',
    'workout.notes': 'Notes',
    'workout.notesPlaceholder': 'e.g., felt strong, slow last reps',
    'workout.send': 'Send',
    'workout.sending': 'Sending...',
    'workout.setsInfo': '{{sets}} sets × {{reps}} {{repsUnit}} • {{rest}}s rest',
    'workout.backToHome': 'Back to Home',
    'workout.goToChat': 'Go to Chat',
    'workout.analyzePerformance': 'Analyze performance',
    'workout.selectDay': 'Select Day',
    'workout.tableHeaders.set': 'Set',
    'workout.tableHeaders.weight': 'Weight',
    'workout.tableHeaders.reps': 'Reps',
    'workout.tableHeaders.rest': 'Rest',
    'workout.tableHeaders.status': 'Status',
    ...
    'nutrition.requiredConsumed': 'required / Consumed',
    'nutrition.betaMessage': 'This is only a beta release, the real power is coming. The upcoming features will level up the experience and turn the product into real, tangible value.',
    ...
    'actions.trackProgressQuick': 'Track my progress',
    ...
    'progress.subtitle': 'Track your fitness journey with intelligent insights',
    'progress.days7': '7 Days',
    'progress.days30': '30 Days',
    'progress.days90': '90 Days',
    'progress.disableRealtime': 'Disable Real-time',
    'progress.enableRealtime': 'Enable Real-time',
    'progress.liveInsights': 'Live Insights',
    'progress.new': 'new',
    'progress.todaysSummary': 'Today\'s Summary',
    'progress.workouts': 'Workouts',
    'progress.exercises': 'Exercises',
    'progress.calories': 'Calories',
    'progress.protein': 'Protein',
    'progress.dayScore': 'Day Score',
    'progress.activityStreak': 'Activity Streak',
    ...
    'progress.totalProtein': 'Total Protein',
    'progress.compliance': 'Compliance',
    'progress.quickStats': 'Quick Stats',
    'progress.newPRs': 'New PRs',
    'progress.aiInsights': 'AI Insights',
    'progress.milestones': 'Milestones',
    'progress.workoutFrequency': 'Workout Freq',
    'progress.perWeek': 'week',
    'progress.personalRecords': 'Personal Records',
    'progress.noPRs': 'No personal records yet. Keep training to set your first PR!',
    'progress.weight': 'Weight',
    'progress.reps': 'Reps',
    'progress.volume': 'Volume',
    'progress.time': 'Time',
    'progress.setOn': 'Set on',
    'progress.aiAnalyzing': 'AI is analyzing your data. Insights will appear here soon!',
    'progress.unread': 'unread',
    'progress.dataFreshness': 'Data freshness',
    'progress.nutritionTracking': 'Nutrition tracking',
    'progress.days': 'days',
    'progress.dataIncomplete': 'Some data may be incomplete',
    'progress.connectionError': 'Connection Error',
    'progress.retry': 'Retry',
    'progress.forceUpdate': 'Force Real-time Update',
    'progress.live': 'Live',
  },
  ar: {
    // Navigation
    ...
    'hero.todaysProgress': 'تقدم اليوم',
    ...
    'ai.progressResponse': 'أرى أنك تحرز تقدماً ممتازاً! دعنا نضبط روتينك لنبقيك متحدياً. ما هو مستوى طاقتك اليوم؟',
    ...
    // Workout Page
    'workout.title': 'جدول التمارين',
    'workout.loading': 'جاري تحميل جدول التمارين...',
    'workout.analyzing': 'جاري تحليل محادثاتك...',
    'workout.noSchedule': 'لم يتم العثور على جدول تمارين. تحدث مع مدرب الذكاء الاصطناعي لإنشاء واحد!',
    'workout.noScheduleDesc': 'لم يتم العثور على جدول تمارين. ابدأ محادثة مع مدرب الذكاء الاصطناعي لإنشاء خطة تمرين مخصصة!',
    'workout.programInfo': 'برنامج {{days}} يوم • مستخرج من محادثاتك',
    'workout.exercisesCount': '{{count}} تمرين • {{sets}} مجموعات إجمالية',
    'workout.currentExercise': 'التركيز حالياً على هذا التمرين',
    'workout.noExercises': 'لم يتم العثور على تمارين لهذا اليوم.',
    'workout.weightUnit': 'وحدة الوزن',
    'workout.kilograms': 'كيلوجرام (كجم)',
    'workout.pounds': 'رطل (رطل)',
    'workout.weight': 'الوزن',
    'workout.reps': 'التكرارات',
    'workout.notes': 'ملاحظات',
    'workout.notesPlaceholder': 'مثال: شعرت بقوة، التكرارات الأخيرة بطيئة',
    'workout.send': 'إرسال',
    'workout.sending': 'جاري الإرسال...',
    'workout.setsInfo': '{{sets}} مجموعات × {{reps}} {{repsUnit}} • {{rest}}ث راحة',
    'workout.backToHome': 'العودة للرئيسية',
    'workout.goToChat': 'اذهب للمحادثة',
    'workout.analyzePerformance': 'حَلِل أدائي',
    'workout.selectDay': 'اخترْ اليوم',
    'workout.tableHeaders.set': 'المجموعة',
    'workout.tableHeaders.weight': 'الوزن',
    'workout.tableHeaders.reps': 'التكرارات',
    'workout.tableHeaders.rest': 'الراحة',
    'workout.tableHeaders.status': 'الحالة',
    ...
    'nutrition.requiredConsumed': 'مطلوب / مستهلك',
    'nutrition.betaMessage': 'هذا إصدار تجريبي فقط، القوة الحقيقية قادمة. الميزات القادمة سترفع مستوى التجربة وتحول المنتج إلى قيمة حقيقية ملموسة.',
    ...
    'actions.trackProgressQuick': 'تتبع تقدمي',
    ...
    // Progress Page
    'progress.title': 'لوحة التقدم',
    'progress.subtitle': 'تتبع رحلتك اللياقة مع رؤى ذكية',
    'progress.days7': '7 أيام',
    'progress.days30': '30 يوم',
    'progress.days90': '90 يوم',
    'progress.disableRealtime': 'تعطيل الوقت الفعلي',
    'progress.enableRealtime': 'تفعيل الوقت الفعلي',
    'progress.liveInsights': 'رؤى حية',
    'progress.new': 'جديد',
    'progress.todaysSummary': 'ملخص اليوم',
    'progress.workouts': 'تمارين',
    'progress.exercises': 'تمارين',
    'progress.calories': 'سعرات',
    'progress.protein': 'بروتين',
    'progress.dayScore': 'درجة اليوم',
    'progress.activityStreak': 'سلسلة النشاط',
    'progress.currentStreak': 'السلسلة الحالية',
    'progress.longestStreak': 'أطول سلسلة',
    'progress.macros': 'الماكروز',
    'progress.totalCalories': 'إجمالي السعرات',
    'progress.totalProtein': 'إجمالي البروتين',
    'progress.compliance': 'الالتزام',
    'progress.quickStats': 'إحصائيات سريعة',
    'progress.newPRs': 'أرقام قياسية جديدة',
    'progress.aiInsights': 'رؤى الذكاء الاصطناعي',
    'progress.milestones': 'إنجازات',
    'progress.workoutFrequency': 'تكرار التمارين',
    'progress.perWeek': 'أسبوع',
    'progress.personalRecords': 'الأرقام القياسية الشخصية',
    'progress.noPRs': 'لا توجد أرقام قياسية بعد. استمر في التدريب لتحقيق رقمك القياسي الأول!',
    'progress.weight': 'الوزن',
    'progress.reps': 'التكرارات',
    'progress.volume': 'الحجم',
    'progress.time': 'الوقت',
    'progress.setOn': 'تم تحديده في',
    'progress.aiAnalyzing': 'الذكاء الاصطناعي يحلل بياناتك. ستظهر الرؤى هنا قريباً!',
    'progress.unread': 'غير مقروء',
    'progress.dataFreshness': 'حداثة البيانات',
    'progress.nutritionTracking': 'تتبع التغذية',
    'progress.days': 'أيام',
    'progress.dataIncomplete': 'قد تكون بعض البيانات غير مكتملة',
    'progress.connectionError': 'خطأ في الاتصال',
    'progress.retry': 'إعادة المحاولة',
    'progress.forceUpdate': 'تحديث الوقت الفعلي القسري',
    'progress.live': 'مباشر',
  },
};
